	...
	************************************************************************************************************/	
		...
		do{			
			if(subDiv.tagName=='DIV' && subDiv.className!='colorPickerCloseButton'){
				if(subDiv==this){
					...
					img.src = "templates/img/tab_right_active.gif"
					...
					img.src = "templates/img/tab_right_inactive.gif"
					self.status = img.src;
	...
	function createColorPickerTopRow(inputObj){
		...
		for(var no=0;no<tabs.length;no++){			
			...
			tabImg.src = "templates/img/tab_right_" + suffix + ".gif";
	...
	{
		color_picker_form_field.value = this.getAttribute('rgbColor').substring(1,7);
		color_picker_div.style.display='none';
	}
